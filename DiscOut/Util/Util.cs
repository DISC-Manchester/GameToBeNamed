...
namespace DiscOut.Util
{
    ...
    internal static class VertexUtils
    {
        ...
        private static readonly Vector3 PerTransform_0 = new Vector3(-3, -2, -4.1982f);
        private static readonly Vector3 PerTransform_1 = new Vector3(3, -2, -4.1982f);
        private static readonly Vector3 PerTransform_2 = new Vector3(-3, 2, -4.1982f);
        private static readonly Vector3 PerTransform_3 = new Vector3(3, 2, -4.1982f);
        private static readonly Vector3 PerTransform_4 = new Vector3(-3, 2, -4.1982f);
        private static readonly Vector3 PerTransform_5 = new Vector3(3, -2, -4.1982f);
    ...
    internal static class AssetUtil
    {
        ...
        {
            Stream stream = exe_base.GetManifestResourceStream("DISCout." + path)
        ...
        public static Stream OpenEmbeddedFile(string path)
            => exe_base.GetManifestResourceStream("DISCout." + path)
                ?? throw new FieldAccessException("could not find embedded file:" + path);
